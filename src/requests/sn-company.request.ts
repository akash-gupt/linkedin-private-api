...
import { SalesNavigatorCompanySearchFilters } from '../types/company-search-filters';
import {
  GetSalesNavigatorCompaniesSearchResponse,
  GetSalesNavigatorCompanySearchResponse,
} from '../responses/sn-company.response.get';
...
export class SalesNavigatorCompanyRequest {
  ...
  getCompany({ companyId }: { companyId: string }): Promise<GetSalesNavigatorCompanySearchResponse> {
